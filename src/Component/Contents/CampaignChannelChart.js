...
const CampaignChannelChart = () => {
    ...
    return(
        <div className="campaign-chart chanel mt-3 pt-3">
          <Spring
          ...
          >
            {props => <Row style={props} className="title-row no-gutters">
              ...
              <Col className="name col-auto">Channel <span className="d-none d-md-inline">Name</span> </Col>
              <Col className="budget">Multiplier</Col>
          ...
          >
            ...
            <Col className="click">
              <span>4,856,857</span>
              <span className="decrease">-15%</span>
            </Col>
          ...
          >
            ...
            <Col className="name col-auto">
              Total  <span className="d-none d-md-inline">( All Channels)</span>
            </Col>
            <Col className="budget d-flex">
              <span>100%</span>
